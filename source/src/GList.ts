...
module fgui {
    ...
    export class GList extends GComponent {
        ...
        */
        ...
        private __clickItem(evt: PIXI.interaction.InteractionEvent): void {
            if (this._scrollPane != null && this._scrollPane.isDragging)
                return;

            const item: GObject = GObject.cast(evt.currentTarget);
            if (!item) {
                return;
            } 
        ...
        private _setVirtual(loop: boolean): void {
            if (!this._virtual) {
                ...
                this._scrollPane.on(ScrollPane.SCROLL, this.__scrolled, this);
                this.setVirtualListChangedFlag(true);
            }
        }
        ...
        public setup_beforeAdd(buffer: ByteBuffer, beginPos: number): void {
            ...
            this._align = AlignMap[buffer.readByte()] || AlignType.Center;
