...
class BasicDemo {
    ...
    private runDemo(evt: fgui.IGObjectInteractionEvent): void {
      
        var type: string = (<fgui.GObject><any>(evt.gObject)).name.substr(4);
    ...
    private playText(): void {
        ...
        obj.getChild("n12").asRichTextField.on(fgui.TextEvent.LinkClick, this.__clickLink, this);
    ...
    private playDragDrop(): void {
        ...
        var rect: PIXI.Rectangle = new PIXI.Rectangle();
    ...
    private playDepth(): void {
        ...
        var startPos: PIXI.Point = new PIXI.Point(fixedObj.x, fixedObj.y);

        obj.getChild("btn0").onClick(function (): void {
        ...
        obj.getChild("btn1").onClick(function (): void {
            var graph: fgui.GGraph = new fgui.GGraph();
            startPos.x += 10;
            startPos.y += 10;
            graph.setXY(startPos.x, startPos.y);
