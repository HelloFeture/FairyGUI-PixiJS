...
class PullToRefreshDemo {
    ...
    private onPullDownToRefresh(evt:  fgui.IGObjectInteractionEvent): void {
        ...
        if (header.readyToRefresh) {
            ...
            fgui.GTimer.inst.add(2000, 1, function (): void {
    ...
    private onPullUpToRefresh(evt: fgui.IGObjectInteractionEvent): void {
